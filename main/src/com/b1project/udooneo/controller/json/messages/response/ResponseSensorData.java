...
import com.b1project.udooneo.controller.json.SensorData;
 ...
 */
public class ResponseSensorData extends ResponseMessage {
    public SensorData content;

    public ResponseSensorData(String method, String info, SensorData content) {
        super(method, info);
